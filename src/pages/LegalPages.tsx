...
const privacySections = [
  ...
  ['Information stored', 'We store your account details, consent record, identifiers, timeline events, possible matches, scoring explanations, notes, activity metadata, and private archive files. Sources and retrieval dates remain attached to saved matches.'],
  ...
  ['Your choices', 'You can correct records, accept or reject possible matches, export JSON or CSV, delete individual records and files, delete all application data, or request permanent account deletion.'],
...
export function PrivacyPage() { return <LegalPage title="Privacy Notice" intro="Your digital history can be deeply personal. EchoTrace is designed around ownership, source attribution, correction, portability, and deletion." sections={privacySections} /> }
